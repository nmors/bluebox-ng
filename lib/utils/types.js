...
function activeInterfaces (value) {
  let interfaceList = [];
  lodash.each(os.networkInterfaces(), (v,k) => { interfaceList.push(k); });

  if (interfaceList.indexOf(value.toLowerCase()) !== -1) {
...
module.exports.interface = activeInterfaces;

//TODO: validate BPF filter
module.exports.filter = function (value) {
  return value;
};

//TODO: validate  SIP file 
module.exports.fileSessions = function (value) {
  return value;
};

//TODO: validate file
module.exports.file = function (value) {
  return value;
};

//TODO: validate socket
module.exports.socket = function (value) {
  return value;
};
